...
fn subtract_impl(input: TwoNumberInput) -> Result<ArithmeticResult, String> {
    ...
    logic::subtract_numbers(logic_input)
}

// Library mode: Primary export for pure function usage
#[cfg(feature = "library")]
pub fn subtract(input: TwoNumberInput) -> Result<ArithmeticResult, String> {
    subtract_impl(input)
}
