...
pub fn arbitrary_rotation_logic(input: ArbitraryRotationInput) -> Result<ArbitraryRotationOutput, String> {
    // Input validation
...
mod tests {
    ...
    fn test_90_degree_z_rotation() {
        ...
        let test_vector = Vector3D { x: 1.0, y: 0.0, z: 0.0 };
    ...
    fn test_180_degree_x_rotation() {
        let axis = Vector3D { x: 1.0, y: 0.0, z: 0.0 };
        ...
        let test_vector = Vector3D { x: 0.0, y: 1.0, z: 0.0 };
        let rotated = result.matrix.multiply_vector(&test_vector);
    ...
    fn test_arbitrary_axis_rotation() {
        ...
        let axis = Vector3D { x: 1.0, y: 1.0, z: 1.0 };
    ...
    fn test_axis_remains_unchanged() {
        ...
        let input = ArbitraryRotationInput { axis: axis.clone(), angle };
        let result = arbitrary_rotation_logic(input).unwrap();
    ...
    fn test_zero_axis_vector() {
        let axis = Vector3D { x: 0.0, y: 0.0, z: 0.0 };
    ...
    fn test_nan_axis_vector() {
        let axis = Vector3D { x: f64::NAN, y: 0.0, z: 1.0 };
        let angle = std::f64::consts::PI / 2.0;
        ...
        assert!(result.is_err());
        assert_eq!(result.unwrap_err(), "Invalid axis vector: contains NaN or infinite values");
    }
    ...
    fn test_large_axis_vector() {
        let axis = Vector3D { x: 1000.0, y: 0.0, z: 0.0 };
        let angle = std::f64::consts::PI / 2.0;
    ...
    fn test_matrix_determinant() {
        ...
        let matrix = Matrix3x3 {
            m00: 2.0, m01: 1.0, m02: 3.0,
            m10: 0.0, m11: 4.0, m12: 1.0,
    ...
    fn test_rotation_matrix_properties() {
        ...
        let test_vector = Vector3D { x: 1.0, y: 2.0, z: 3.0 };
