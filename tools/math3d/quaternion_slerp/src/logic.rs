...
pub fn quaternion_slerp_logic(
    input: QuaternionSlerpInput,
) -> Result<QuaternionSlerpOutput, String> {
    // Input validation
...
mod tests {
    ...
    fn test_nan_quaternion() {
        ...
        assert_eq!(
            result.unwrap_err(),
            "Invalid quaternion q1: contains NaN or infinite values"
        );
    }
    ...
    fn test_infinite_quaternion() {
        ...
        assert_eq!(
            result.unwrap_err(),
            "Invalid quaternion q2: contains NaN or infinite values"
        );
    }
    ...
    fn test_nan_t_parameter() {
        ...
        assert_eq!(
            result.unwrap_err(),
            "Invalid interpolation parameter t: must be finite"
        );
    }
